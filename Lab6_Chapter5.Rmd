...
using {spdep} package to build neighborhood weights and list to calculate local Moran's I.
...
A dummy variable, `burglary.isSig`, denotes a cell as part of a significant cluster (a p-value <= 0.0000001). `burglary.isSig.dist` then measures average nearest neighbor distance from each cell centroid to its nearest significant cluster.
